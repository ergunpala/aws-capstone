...
def get_ssm_parameters():
    ...
    username_param = ssm.get_parameter(Name="/ergun/capstone/username", WithDecryption=True)
    password_param = ssm.get_parameter(Name="/ergun/capstone/password", WithDecryption=True)
...
DATABASES = {
    'default': {
        ...
        'HOST': 'ergun-capstone.cr6k2w4a4y5l.us-east-1.rds.amazonaws.com',
        'PORT': '3306',
    }
}
...
AWS_STORAGE_BUCKET_NAME = 'ergun-awscapstones-blog' # please enter your s3 bucket name
